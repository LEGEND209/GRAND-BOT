...
TOKEN="Nzk5NjQwNTM1NzM2MjU0NTQ0.YAGhSA.QyqHEiXvpg0bmvHQ3x6qfNGNhWI" #example - "bjqfebjlnqklnifbnaewnhnfoiqefioqip"
...
async def on_member_join(member):
    ...
    wel_channel = guild.get_channel('791304977196253204') #example - bot.guild.get_channel(733224387263856681) 
...
async def on_member_remove(member):
    ...
    leave_channel = guild.get_channel('788994914364817458') #example - bot.guild.get_channel(733224387263856681) 
...
async def support(ctx):
    await ctx.send('https://discord.gg/pA6X8rRSbR | Contact = GRΔΠD 丶R€ꗇŁ ❘| LEGEND👑')
#0001')
...
async def link(ctx):
    masked_link_embed = discord.Embed(
        ...
        description='[CLICK HERE](https://discord.gg/pA6X8rRSbR)'
    )
...
async def invite(ctx):
    masked_link_embed = discord.Embed(
        ...
        description='[CLICK HERE](https://discord.com/api/oauth2/authorize?client_id=799640535736254544&permissions=8&scope=bot)',
    )
    await ctx.send(embed=masked_link_embed)
...
bot.run(Nzk5NjQwNTM1NzM2MjU0NTQ0.YAGhSA.QyqHEiXvpg0bmvHQ3x6qfNGNhWI)
